...
public interface RestApi {
     ...
     */
    @GET("/v2/phone_search")
    Observable<SearchResponse> getPhoneSearch(@Query("phone") String phone, @QueryMap Map<String, String> params);
     ...
     */
    @GET("/v2/search")
    Observable<SearchResponse> search(@Query("location") String location, @QueryMap Map<String, String> params);
